...
<p align="center"><strong><code>@@arham/safe-area</code></strong></p>
<p align="center">
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@@arham/safe-area"><img src="https://img.shields.io/npm/l/@@arham/safe-area?style=flat-square" /></a>
<br>
  <a href="https://www.npmjs.com/package/@@arham/safe-area"><img src="https://img.shields.io/npm/dw/@@arham/safe-area?style=flat-square" /></a>
  <a href="https://www.npmjs.com/package/@@arham/safe-area"><img src="https://img.shields.io/npm/v/@@arham/safe-area?style=flat-square" /></a>
</p>
...
```ts
import { SafeArea } from '@@arham/safe-area';
...
```ts
import { initialize } from '@@arham/safe-area';
...
```ts
/// <reference types="@arham/safe-area" />
